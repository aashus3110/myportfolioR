...
const Skills = () => {
  return (
    <div className="skills md:h-full pt-12 px-8 h-full w-full bg-violet-900 text-white">
      ...
      <div className="border-l-2 border-t-0 lg:border-t-2 lg:border-l-0 h-full md:h-[85%] lg:h-[60%] border-violet-300 flex flex-col  lg:flex-row lg:justify-evenly ">
        <div className="h-12 w-60 lg:w-0 border-b-2 lg:border-r-2 border-violet-300"></div>
